        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            >
              <div className="flex items-start gap-4">
                <div className="rounded-full bg-[#DD9933]/10 p-2">
            ...
            <div className="space-y-4">
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#212121] transition-colors duration-300 group-hover:bg-[#DD9933]/20">
          ...
          >
            ...
            >
              ...
              {/* Decorative border */}
              <div className="absolute inset-0 rounded-2xl border border-[#DD9933]/20" />
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 rounded-xl bg-[#212121] p-4 shadow-xl"
            >
              <p className="text-sm text-white/60">Täglich geöffnet</p>
              <p className="text-lg font-bold text-[#DD9933]">10:00 - 06:00</p>
            </motion.div>
          </motion.div>
        </div>
      </motion.div>
